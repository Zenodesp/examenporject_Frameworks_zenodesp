...
namespace examenporject_Frameworks_zenodesp.Migrations
{
    ...
    [Migration("20231219105608_languages2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("examenporject_Frameworks_zenodesp.Areas.Identity.Data.EmployeeUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("examenporject_Frameworks_zenodesp.Models.Appointment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("examenporject_Frameworks_zenodesp.Models.Complaint", b =>
                {
                    ...
                    b.Property<string>("complaintLoggerId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("examenporject_Frameworks_zenodesp.Models.ComplaintType", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("examenporject_Frameworks_zenodesp.Models.Language", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(2)
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("examenporject_Frameworks_zenodesp.Areas.Identity.Data.EmployeeUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("examenporject_Frameworks_zenodesp.Models.Appointment", b =>
                {
                    b.HasOne("examenporject_Frameworks_zenodesp.Models.Complaint", "Complaint")
                        .WithMany()
                        .HasForeignKey("ComplaintId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("examenporject_Frameworks_zenodesp.Areas.Identity.Data.EmployeeUser", "Employee")
                        .WithMany()
